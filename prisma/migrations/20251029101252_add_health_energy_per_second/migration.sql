...
CREATE TABLE "new_User" (
    ...
    "healthPerSecond" REAL NOT NULL DEFAULT 0.1,
    "energyPerSecond" REAL NOT NULL DEFAULT 0.05,
    CONSTRAINT "User_referredById_fkey" FOREIGN KEY ("referredById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_User" ("coins", "createdAt", "energy", "firstName", "health", "id", "isBot", "languageCode", "lastMiningTick", "lastName", "level", "maxEnergy", "maxHealth", "miningRate", "miningStarted", "referredById", "telegramId", "tempCoins", "updatedAt", "username", "vaultCapacity") SELECT "coins", "createdAt", "energy", "firstName", "health", "id", "isBot", "languageCode", "lastMiningTick", "lastName", "level", "maxEnergy", "maxHealth", "miningRate", "miningStarted", "referredById", "telegramId", "tempCoins", "updatedAt", "username", "vaultCapacity" FROM "User";
DROP TABLE "User";
