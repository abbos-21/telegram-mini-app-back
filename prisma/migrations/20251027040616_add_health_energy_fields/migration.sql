...
INSERT INTO "new_User" ("coins", "createdAt", "firstName", "id", "isBot", "languageCode", "lastMiningTick", "lastName", "level", "miningRate", "miningStarted", "referredById", "telegramId", "tempCoins", "updatedAt", "username", "vaultCapacity") SELECT "coins", "createdAt", "firstName", "id", "isBot", "languageCode", "lastMiningTick", "lastName", "level", "miningRate", "miningStarted", "referredById", "telegramId", "tempCoins", "updatedAt", "username", "vaultCapacity" FROM "User";
DROP TABLE "User";
